...
public class ObjectFactory {
    ...
    private final static QName _GetDateResponse_QNAME = new QName("http://timeservice/", "getDateResponse");
    private final static QName _GetDate_QNAME = new QName("http://timeservice/", "getDate");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://timeservice/", name = "getDateResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://timeservice/", name = "getDate")
